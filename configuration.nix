...

{
  ...
  networking.hostName = "kevinix"; # Define your hostname.
  ...
  # Allow precompiled binaries to run
  ...
  fonts.packages = with pkgs; [
    ...
    # Include any full patched fonts you use for your terminal (e.g., FiraCode)
