...
- [ray-janet-poc](project_ray_janet_poc.md) — Janet 1.41 scene description + TCP eval server (port 4007); Stage 1-5 done; 0.9× Lambert, 1.7× Blinn-Phong (tuple GC); comint + CAPF completion; Nix dev shell required
