...
- [ray-janet-poc](project_ray_janet_poc.md) — Janet 1.41 scene + TCP eval server (port 4007); Stage 1-5 done; 0.9× Lambert / 1.7× Blinn-Phong (Linux), 1.0× / 1.9× (macOS); comint + CAPF; Nix dev shell required
